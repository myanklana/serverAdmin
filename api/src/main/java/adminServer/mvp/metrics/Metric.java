...
public class Metric {
    ...
    @Column(name = "network_received_bytes", nullable = false)
    private long networkReceivedBytes;
    @Column(name = "network_sent_bytes", nullable = false)
    private long networkSentBytes;
    @Column(name = "network_received_bytes_per_second", nullable = false)
    private long networkReceivedBytesPerSecond;
    @Column(name = "network_sent_bytes_per_second", nullable = false)
    private long networkSentBytesPerSecond;

    protected Metric() {
    }

    public Metric(ManagedServer server, Instant collectedAt, double cpuPercent, long memoryUsedBytes,
        ...
        this.networkReceivedBytesPerSecond = networkReceivedBytesPerSecond;
    ...
    public long getNetworkReceivedBytesPerSecond() {
        return networkReceivedBytesPerSecond;
    }

    public long getNetworkSentBytesPerSecond() {
